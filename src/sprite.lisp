...
(defproto =image= (=textured=)
  ((texture (create-texture "/home/sykopomp/hackery/lisp/until-it-dies/res/lisplogo_alien_256.png")))
  (:documentation
...
(defproto =animation= (=image=)
  ((texture (create-texture "/home/sykopomp/hackery/lisp/until-it-dies/res/explosion.png"))
   (current-frame 0)
   (num-frames 14)
   (frame-delay 50)
   (frame-width 15)
